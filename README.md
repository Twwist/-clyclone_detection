...
_Примечание_: после перехода по ссылке нужно будет выделить файл **weights.pt**, и после этого нажать "Скачать", после чего преместить в ту же папку что и solution.py
